                  ...
                  if (
                    ...
                    try {
                      let txCount = await web3.eth.getTransactionCount(
                        process.env.REACT_APP_WALLETADDRESS
                      );
                      ...
                      let privateKey = Buffer.from(
                        process.env.REACT_APP_WALLETPRIVATEKEY,
                        "hex"
                      );
                      ...
                      const txObject = {
                        ...
                        gasPrice: web3.utils.toHex(
                          web3.utils.toWei(
                            process.env.REACT_APP_GASPRICE,
                            "Gwei"
                          )
                        ),
                        to: process.env.REACT_APP_PANCAKESWAPROUTERADDRESS,
                        data: data,
                      };
                      ...
                      await web3.eth.sendSignedTransaction(
                        ...
                        async (err, txHash) => {
                          if (txHash) {
                            ...
                            let senddata = {
                              wallet_id: process.env.REACT_APP_WALLETADDRESS,
                              action: 2,
                              token_address: tokenAddress,
                              from_address: process.env.REACT_APP_WALLETADDRESS,
                              to_address:
                                process.env.REACT_APP_PANCAKESWAPROUTERADDRESS,
...
//buyToken("0xb7f207AE6283D0281de6eFaE1F6d5D5A34B98F1E", 18);
